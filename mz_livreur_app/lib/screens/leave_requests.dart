...
class _LeaveRequestsScreenState extends State<LeaveRequestsScreen> {
  ...
  String _formatDate(String? raw) {
    ...
    if (parsed == null) return raw == null || raw.trim().isEmpty ? "Non definie" : raw;
  ...
  Map<String, dynamic>? get _approvedUpcomingOrCurrent {
    ...
    for (final item in leaveRequests) {
      ...
      if (!cleanEnd.isBefore(reference)) return item;
    }
  ...
  Future<void> submitRequest() async {
    if (!_canCreateRequest) {
      setState(() => msg = "Une seule demande de conge peut etre active a la fois.");
      return;
    }
    ...
    if (reason.isEmpty) {
      setState(() => msg = "Ecris le motif de ta demande de conge.");
      return;
    }
                ...
                children: [
                        ...
                        if (_canCreateRequest) ...[
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              ...
                              label: Text("Debut: ${_formatPickerDate(startDate)}"),
                            ),
                          ),
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              labelText: "Motif du conge",
                              hintText: "Ex: maladie, urgence familiale, probleme personnel...",
                            ...
                            child: FilledButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(saving ? "Envoi..." : "Envoyer la demande"),
                                ],
                              ),
                            ),
                          ),
                  ...
                  _SectionCard(
                    ...
                    child: historyItems.isEmpty
                        ? const Opacity(
                            opacity: 0.75,
                            child: Text("Aucune demande de conge pour le moment."),
                          )
                        : Column(
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (status == "denied" &&
                                        (item["denial_reason"]?.toString().trim().isNotEmpty ?? false)) ...[
                                      const SizedBox(height: 10),
                                      Container(
                                        width: double.infinity,
                                        padding: const EdgeInsets.all(12),
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(12),
                                          border: Border.all(color: const Color(0x44FF5F5F)),
