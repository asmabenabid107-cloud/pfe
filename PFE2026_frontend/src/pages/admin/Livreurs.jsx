...
import { DEPOT_OPTIONS, REGION_OPTIONS } from "../../constants/courierOptions.js";
      ...
      >
        <div>
          ...
          <div style={{ opacity: 0.78, fontSize: 13, marginTop: 4 }}>
            La region, le depot et la date de fin de contrat sont choisis au moment de l'approbation.
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: 6, opacity: 0.74, fontSize: 13 }}>
              Choisis la region, le depot et la date de fin de contrat de <strong>{approvalTarget.name}</strong>.
