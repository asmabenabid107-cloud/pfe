      ...
      >
        <div>
          ...
          <div style={{ opacity: 0.78, fontSize: 13, marginTop: 4 }}>
            Gère la région, le dépôt et le statut des livreurs approuvés.
          </div>
        </div>
        ...
        >
          ...
          >
            <div style={{ fontSize: 20, fontWeight: 900 }}>
              {editMode === "region"
                ? "Modifier la région et le dépôt"
                : "Modifier le statut"}
            </div>
            ...
            <div style={{ marginTop: 6, opacity: 0.74, fontSize: 13 }}>
              {editMode === "region" ? (
                <>
                  Mets à jour la région et le dépôt de travail de{" "}
