    ...
    return (
      <button
        ...
        style={{
          ...
          fontWeight: 800,
          fontSize: "0.82rem",
          background: active ? "rgba(44,203,118,.14)" : "rgba(255,255,255,.04)",
          border: active ? "1px solid rgba(44,203,118,.45)" : "1px solid rgba(255,255,255,.10)",
          color: active ? "var(--success)" : "rgba(232,238,252,0.65)",
        }}
      >
        {depot.label}
      </button>
